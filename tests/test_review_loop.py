...
# The four outcomes a round can end in. Three of them show the same green
# check, so losing one from the entrypoint's table is the failure the whole
# skill exists to prevent.
OUTCOMES = ("clean", "findings", "stalled", "skipped")
...
class ReviewLoopPackagingTests(unittest.TestCase):
    ...
    def test_the_loop_stays_bounded_and_hands_merging_to_a_human(self) -> None:
        ...
        self.assertIn("Round cap", ENTRYPOINT)
